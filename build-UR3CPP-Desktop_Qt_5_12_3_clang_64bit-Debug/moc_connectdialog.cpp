...
#include "../../../../Desktop/UR3TestApp/connectdialog.h"
...
QT_MOC_LITERAL(1, 14, 14), // "ConnectClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 2), // "ip"
QT_MOC_LITERAL(4, 33, 4), // "port"
QT_MOC_LITERAL(5, 38, 20) // "ConnectButtonClicked"

    },
    "ConnectDialog\0ConnectClicked\0\0ip\0port\0"
...
void ConnectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ConnectClicked((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ConnectDialog::*)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectDialog::ConnectClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConnectDialog::ConnectClicked(QString _t1, int _t2)
{
