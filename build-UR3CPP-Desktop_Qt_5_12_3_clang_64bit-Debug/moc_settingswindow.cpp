...
#include "../../../../Desktop/settings/settingswindow.h"
...
QT_MOC_LITERAL(1, 15, 16), // "settingsAccepted"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 21) // "on_buttonBox_accepted"

    },
    "SettingsWindow\0settingsAccepted\0\0"
...
void SettingsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsWindow::settingsAccepted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingsWindow::settingsAccepted()
{
